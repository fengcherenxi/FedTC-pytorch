...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        if (iter + 1) % args.test_freq == 0:
            acc_test, loss_test = test_img_cur_model(net_glob,dataset_test,args)
            ...
            for user_idx in range(args.num_users):
                best_save_path = os.path.join(base_dir, algo_dir, 'best_local_'+str(user_idx)+'.pt')
