...
from models.Update import LocalUpdateFedBN
from models.test import test_img_local_all,test_img_cur_model
...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateFedBN(args=args, dataset=dataset_train, idxs=dict_users_train[idx])
        ...
        update_keys = [k for k in update_keys if 'bn' not in k]
